...
from algorithms.options import MetaPolicyQLearning
...
policy = MetaPolicyQLearning(env, eval_env, fsa, T, alpha=alpha,
                              epsilon= epsilon, num_episodes=num_episodes,
                                episode_length=episode_length, writer=writer,
                                  eval_freq=eval_freq)
